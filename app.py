...
def render_landing_page():
    ...
    st.markdown(
        ...
        .landing-hero {
            ...
            background:
                radial-gradient(circle at 86% 10%, rgba(20,184,166,.18), transparent 30%),
                linear-gradient(135deg, #FFFFFF 0%, #F3FAFF 60%, #ECFDF5 100%);
        ...
        .landing-copy strong { color:#0F172A; }
        .landing-disclaimer {
            color: #718096;
            font-size: .82rem;
            margin-top: 12px;
        }
        .sample-blueprint-card {
        ...
        .score-ring {
            ...
            height: 122px;
            border-radius: 50%;
            background: conic-gradient(#16A34A 0 72%, #2563EB 72% 88%, #E8F0FA 88% 100%);
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        .worry-strip {
            display: grid;
            grid-template-columns: 112px 1fr 245px;
            gap: 24px;
            align-items: center;
            background: #FFFFFF;
            border: 1px solid #DDEBFA;
        ...
        .percent-ring {
            ...
            height: 96px;
            border-radius: 50%;
            background: conic-gradient(#2563EB 0 67%, #D8E8FB 67% 100%);
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        .bottom-cta {
            background: linear-gradient(135deg, #EAF5FF 0%, #F8FCFF 70%, #DDF7F1 100%);
        ...
        @media (max-width: 900px) {
            .landing-hero, .worry-strip, .answer-grid, .steps-grid, .style-grid {
                grid-template-columns: 1fr;
            }
            .landing-hero { padding: 28px; }
            .sample-main { grid-template-columns: 1fr; justify-items: center; text-align: center; }
            .clarity-box { border-left: none; border-top: 1px solid #D7E3F2; padding-left: 0; padding-top: 18px; }
        }
        </style>
        """,
        unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div class="landing-hero">
            <div>
                <div class="landing-kicker">🧭 Retirement Blueprint 101</div>
                <div class="landing-title">Know when you can retire — in plain English.</div>
                <div class="landing-copy">
                    Answer a few simple questions and see whether your retirement plan looks
                    <strong>strong, risky, or somewhere in between.</strong>
                </div>
                <div class="landing-copy">
                    No confusing jargon. No giant spreadsheet. Just a simple retirement blueprint you can understand.
                </div>
            </div>

            <div class="sample-blueprint-card">
                <div class="sample-title-row">
                    <div class="sample-title">Sample Blueprint</div>
                    <div class="sample-pill">Example Only</div>
                </div>
                ...
                <div class="sample-main">
                    ...
                    <div>
                        <div class="sample-summary-title">Comfortable, with room to improve</div>
                        <div class="sample-summary-copy">Your real blueprint will be built from your answers.</div>
                    </div>
                </div>
                ...
                <div class="sample-list">
                    <div class="sample-row">
                        ...
                        <div><div class="sample-label">Suggested Retirement Age</div><div class="sample-value">62</div></div>
                    </div>
                    <div class="sample-row">
                        <div class="sample-icon">⏳</div>
                        <div><div class="sample-label">Money May Last To</div><div class="sample-value">Age 90</div></div>
                    </div>
                    <div class="sample-row">
                        <div class="sample-icon">💵</div>
                        <div><div class="sample-label">Monthly Income Gap</div><div class="sample-value">$450</div></div>
                    </div>
                    <div class="sample-row">
                        <div class="sample-icon">✅</div>
                        <div><div class="sample-label">Next Best Step</div><div class="sample-value">Save $150 more/month or retire 1 year later</div></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    cta_left, cta_right = st.columns([1, 3])
    with cta_left:
        if st.button("Start My Free Blueprint", type="primary", use_container_width=True, key="landing_start_top"):
            go_to_page("Guided Questions")
    with cta_right:
        st.markdown('<div class="landing-disclaimer">Educational planning tool. Not financial, tax, legal, or investment advice.</div>', unsafe_allow_html=True)

    st.markdown(
        """
        <div class="worry-strip">
            <div class="percent-ring"><span>67%</span></div>
            <div>
                <div class="worry-title">67% of people are more afraid of running out of money in retirement than death.</div>
                <div class="worry-copy">That is why this tool helps you see if your money may last.</div>
            </div>
            <div class="clarity-box">
                <strong>Clarity today.<br/>Confidence tomorrow.</strong>
        ...
        <div class="answer-grid">
            <div class="answer-card">
                ...
                <h3>Can I retire when I want?</h3>
                <p>See if your target retirement age looks realistic.</p>
            </div>
            <div class="answer-card">
                <div class="answer-icon">🕒</div>
                <h3>Will my money last?</h3>
                <p>View a simple money timeline built from your answers.</p>
            </div>
            <div class="answer-card">
                <div class="answer-icon">📋</div>
                <h3>What should I improve first?</h3>
                <p>Get plain-English next steps to strengthen your plan.</p>
            </div>
        </div>
        ...
        <div class="steps-grid">
            <div class="step-card">
                ...
                <div><strong>Answer simple questions</strong><span>Age, savings, spending, income, and Social Security.</span></div>
            </div>
            <div class="step-card">
                <div class="step-num">2</div>
                <div><strong>Get your first blueprint</strong><span>See your score, timeline, and risk areas.</span></div>
            </div>
            <div class="step-card">
                <div class="step-num">3</div>
                <div><strong>Improve your plan</strong><span>Compare options and see what helps most.</span></div>
            </div>
        </div>

        <div class="simple-box">
            <h3>Start simple. Go deeper only if you want.</h3>
            <div class="style-grid">
                <div class="style-card"><strong>🛡️ Careful</strong><span>More cautious estimate using a 4.5% return.</span></div>
                <div class="style-card"><strong>⚖️ Balanced</strong><span>Middle-ground estimate using a 6.5% return.</span></div>
                <div class="style-card"><strong>📈 Growth</strong><span>Higher-growth estimate using an 8.0% return.</span></div>
            </div>
            <div class="landing-disclaimer">You can adjust advanced settings later.</div>
        </div>

        <div class="bottom-cta">
            <h2>Retirement planning does not have to feel overwhelming.</h2>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
if active_page == PAGE_NAMES[6]:
    ...
    if not can_run:
        ...
        with hero1:
            ...
            ">
                <div style="font-size:18px;font-weight:700;opacity:0.9;">
                    Retirement Timing Viability
                </div>
                <div style="font-size:70px;font-weight:900;line-height:1;">
                    {rtv_score}
                </div>
                <div style="
                    font-size:20px;
        ...
        c5.metric("Income Coverage", pct(df["Income Coverage Ratio"].mean()))
        ...
        if float(st.session_state.monthly_mortgage or 0) > 0:
            if int(st.session_state.mortgage_payoff_age or 0) > int(st.session_state.retire_age or 0):
                st.warning("Your mortgage appears to continue into retirement. This can increase early retirement cash-flow pressure.")
            else:
                st.success("Your mortgage appears to be paid off by retirement age, based on your payoff-age input.")

        if st.session_state.retirement_housing_plan in ["Downsize", "Relocate", "Snowbird"]:
            st.info("Your housing plan may create flexibility. Downsizing, relocating, or snowbirding can reduce expenses, unlock equity, or change state tax exposure.")
        ...
        st.caption("Compares annual spending, outside income, and how much must come from the portfolio.")
        st.pyplot(plot_spending_income_bar_chart(df), use_container_width=True)

        st.subheader("Income Gap")
        st.caption("Shows how much spending is not covered by guaranteed/outside income and must be filled by portfolio withdrawals.")
